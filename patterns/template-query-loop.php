...
?>
<!-- wp:query {"queryId":0,"query":{"perPage":10,"pages":0,"offset":0,"postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":true,"taxQuery":null,"parents":[]},"metadata":{"categories":["salnama-features"],"patternName":"salnama/template-query-loop","name":"List of posts, 1 column"},"align":"full","layout":{"type":"default"}} -->
