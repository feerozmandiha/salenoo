...
<!-- wp:paragraph -->
<p>تلفن: <a href="tel:09124533878">09124533878</a></p>
<!-- /wp:paragraph -->
...
<!-- wp:social-link {"url":"https://t.me/salnama","service":"telegram"} /-->

<!-- wp:social-link {"url":"info@salenoo.ir","service":"mail"} /--></ul>
<!-- /wp:social-links --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->

<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"6px","right":"0px","bottom":"6px","left":"0px"},"blockGap":"10px"},"border":{"top":{"color":"var:preset|color|brand-teal","width":"1px"}}},"layout":{"type":"flex","flexWrap":"wrap","justifyContent":"left"}} -->
<div class="wp-block-group alignfull" style="border-top-color:var(--wp--preset--color--brand-teal);border-top-width:1px;padding-top:6px;padding-right:0px;padding-bottom:6px;padding-left:0px"><!-- wp:paragraph {"style":{"typography":{"textAlign":"center"}}} -->
<p class="has-text-align-center">این سایت متعلق به</p>
<!-- /wp:paragraph -->

<!-- wp:site-title {"level":4,"style":{"typography":{"fontStyle":"normal","fontWeight":"700"}}} /-->

<!-- wp:paragraph {"style":{"typography":{"textAlign":"center"}}} -->
<p class="has-text-align-center">می باشد.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->